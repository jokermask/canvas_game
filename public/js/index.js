...
/***/ function(module, exports, __webpack_require__) {
	...
	var _barrier = __webpack_require__(6);
	...
	var Engine = function () {
	  ...
	  _createClass(Engine, [{
	    ...
	    key: 'keyPressed',
	    value: function keyPressed(keyCode, spriteList, barrierList) {
	      ...
	      try {
	        for (var _iterator = spriteList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      $(document).keyup(function (e) {
	        if (keyList) {
	          if (e.keyCode == keyList[keyList.length - 1] && keyList.length != 1) {
	            ...
	            var idx = $.inArray(e.keyCode, keyList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = function (_Sprite) {
	  ...
	  _createClass(Player, [{
	    ...
	    key: 'addListener',
	    value: function addListener(keyListener) {
	    ...
	    value: function initListener() {
	      ...
	      this.listeners['up'] = new _listener.Listener('up', function () {
	        if (!_this2.isCollsion(_this2.x, _this2.y - _this2.speed)) {
	          _this2.update(_this2.x, _this2.y - _this2.speed);
	        }
	      });
	      this.listeners['down'] = new _listener.Listener('down', function () {
	        if (!_this2.isCollsion(_this2.x, _this2.y + _this2.speed)) {
	          _this2.update(_this2.x, _this2.y + _this2.speed);
	        }
	      });
	      this.listeners['left'] = new _listener.Listener('left', function () {
	        if (!_this2.isCollsion(_this2.x - _this2.speed, _this2.y)) {
	          _this2.update(_this2.x - _this2.speed, _this2.y);
	        }
	      });
	      this.listeners['right'] = new _listener.Listener('right', function () {
	        if (!_this2.isCollsion(_this2.x + _this2.speed, _this2.y)) {
	          _this2.update(_this2.x + _this2.speed, _this2.y);
	        }
	      });
	    ...
	    key: 'getBarrierList',
	    value: function getBarrierList(barrierList) {
	      this.barrierList = barrierList;
	    }
	  }, {
	    key: 'isCollsion',
	    value: function isCollsion(x, y) {
	      for (var i in this.barrierList) {
	    ...
	    key: 'collisionDect',
	    value: function collisionDect(obj1, obj2) {
	      var x1 = obj1.x;
	      var y1 = obj1.y;
	      var x2 = obj2.x;
	      var y2 = obj2.y;
